...
export const refundProcessSections: LegalSection[] = [
  {
    ...
    blocks: [
      subheading("5.1 How to request a refund"),
      ...
      subheading("5.3 Refund processing"),
  ...
  },
  {
    ...
    blocks: [
      subheading("7.1 Internal resolution"),
      ...
      subheading("7.2 Escalation process"),
      ...
      subheading("7.3 Chargeback policy"),
  ...
  },
  {
    ...
    blocks: [
      ...
      subheading("8.2 Account violations"),
  ...
  },
  {
    ...
    blocks: [
      subheading("9.1 Indian law compliance"),
      ...
      subheading("9.2 Payment gateway compliance"),
  ...
  },
  {
    ...
    blocks: [
      subheading("10.1 Data retention"),
      ...
      subheading("10.2 Privacy protection"),
  ...
  },
  {
    ...
    blocks: [
      subheading("11.1 Modification rights"),
      ...
      subheading("11.2 Grandfathering"),
